...
// Pre: state and roster should be empty; loading into a game in progress is not supported.
// Post: Fills state and roster from the file and returns true. Returns FALSE and touches nothing
//       if the file does not exist -- that is not an error, it is a first run.
