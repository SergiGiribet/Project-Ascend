...
**Crònica d'incursió** (un bloc per pis; esdeveniments indentats):
```
Floor 4: The team advances with difficulty.
  Hazel reaches level 2!
  Beatrice, Reckless as ever, is wounded holding the line.
Climb to floor 5? [1] Yes  [2] Return
```

**Tancament d'incursió**:
```
=== Incursion <n> over ===
...
- **Causes de mort**: curtes, en minuscula, sense punt (la lapida el posa): `wounded holding the line`,
  `overwhelmed in the retreat`. Cada nou desenllaç de mort ha de portar la seva causa propia.
